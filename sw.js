var CACHE_NAME = 'greenroof-v2.35';
var ASSETS = [
  './',
  './index.html',
  './css/main.css?v=2.35',
  './js/gateway.js?v=2.35',
  './js/state.js?v=2.35',
  './js/utils.js?v=2.35',
  './js/ui/cards.js?v=2.35',
  './js/ui/modal.js?v=2.35',
  './js/ui/dashboard.js?v=2.35',
  './js/ui/map-route.js?v=2.35',
  './js/ui/checkin.js?v=2.35',
  './js/ui/common.js?v=2.35',
  './js/api.js?v=2.35',
  './js/auth.js?v=2.35',
  './js/app.js?v=2.35',
  './js/firebase-config.js?v=2.35',
  './js/error-reporter.js?v=2.35',
  './js/locales/zh-TW.js?v=2.35',
  './js/locales/en.js?v=2.35',
  './png.png'
];
