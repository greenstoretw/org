var CACHE_NAME = 'greenroof-v2.36';
var ASSETS = [
  './',
  './index.html',
  './css/main.css?v=2.36',
  './js/gateway.js?v=2.36',
  './js/state.js?v=2.36',
  './js/utils.js?v=2.36',
  './js/ui/cards.js?v=2.36',
  './js/ui/modal.js?v=2.36',
  './js/ui/dashboard.js?v=2.36',
  './js/ui/map-route.js?v=2.36',
  './js/ui/checkin.js?v=2.36',
  './js/ui/common.js?v=2.36',
  './js/api.js?v=2.36',
  './js/auth.js?v=2.36',
  './js/app.js?v=2.36',
  './js/firebase-config.js?v=2.36',
  './js/error-reporter.js?v=2.36',
  './js/locales/zh-TW.js?v=2.36',
  './js/locales/en.js?v=2.36',
  './png.png'
];
