var CACHE_NAME = 'greenroof-v2.23';
var ASSETS = [
  './',
  './index.html',
  './css/main.css',
  './js/gateway.js?v=2.23',
  './js/state.js?v=2.23',
  './js/utils.js?v=2.23',
  './js/ui/cards.js?v=2.23',
  './js/ui/modal.js?v=2.23',
  './js/ui/dashboard.js?v=2.23',
  './js/ui/map-route.js?v=2.23',
  './js/ui/checkin.js?v=2.23',
  './js/ui/common.js?v=2.23',
  './js/api.js?v=2.23',
  './js/auth.js?v=2.23',
  './js/app.js?v=2.23',
